      ...
      <div id="content" className="site-content">
        ...
        <div className="page-content-wrapper center-relative content-1170">
          <div className="page-content">
            <div className="one_half" style={{ color: "black" }}>
              <p>
          ...
          <div className="full-page-width center-relative">
            <div className="video-iframe">
              {/* Google Map */}
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.5487872634663!2d106.8362629!3d-6.3024686999999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69edf4233519c7%3A0xd742b9d2b20a6752!2sGKM%20Green%20Tower!5e0!3m2!1sen!2sid!4v1708012345678"
                width="600"
                height="450"
                loading="lazy"
              ></iframe>
