...
// Images
// import logo from "@/assets/images/logo-bagusmedia-white.png";
import logo from "@/assets/images/logo-bagusmedia-primer.png";
            ...
            >
              <nav id="header-main-menu" className="big-menu">
                ...
                <ul className="main-menu sm sm-clean">
                  ...
                  {/* Sub menu */}
                  <li className="sum-menu-li hi" style={{ display: "none" }}>
